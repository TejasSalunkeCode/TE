...
function createCompanyCard(company, index) {
    ...
    let badgeColor = '#6366f1'; // Indigo (Plastindia)
    if (company.source === 'IMTEX 2026') badgeColor = '#10b981'; // Emerald
    if (company.source === 'PlastEurasia 2024') badgeColor = '#f59e0b'; // Amber
    if (company.source === 'K 2025') badgeColor = '#ef4444'; // Red
    if (company.source === 'ArabPlast 2025') badgeColor = '#8b5cf6'; // Violet
    ...
    const badgeText = company.source || 'Verified Source';
